  ...
  <section id="main-content">
    ...
    <div class="tour-list1 container marT30">
     <?php if( $page->id == 2 ) { ?>	
        ...
        <figure><img src="<?php echo 'http://'.AWS_S3_BUCKET.'.s3.amazonaws.com/tours/food-wine-pghead.jpg'; ?>" class="attachment-620 wp-post-image" alt="<?php echo 'Food &amp; wine tour'; ?>" /></figure>
        <!-- <h1 class="ourvillas foodwine">Food &amp; Wine Tours</h1> -->
        </div>
    <?php } else { ?>
    	<div class="fourcol left last">
        <figure><img src="<?php echo 'http://'.AWS_S3_BUCKET.'.s3.amazonaws.com/tours/food-wine-pghead.jpg'; ?>" class="attachment-620 wp-post-image" alt="<?php echo 'Food &amp; wine tour'; ?>" /></figure>
        <!-- <h1 class="ourvillas foodwine">Cultural &amp; Sightseeing</h1> -->
        </div>
    <?php } ?>
	 ...
	 ?>
		...
		if( isset($ListTour) && count($ListTour)>0 ) { 
			...
			foreach ($ListTour as $l) { 
				  ...
				  $items = 'http://'.AWS_S3_BUCKET.'.s3.amazonaws.com/'.$l->id.'/fullsize/'.$img->img_url;  
        ...
        <article class="post-234 post type-post status-publish format-standard has-post-thumbnail hentry category-articles col span_11 first">
          ...
          <div class="page tourlist hentry col span_12 first">
            <p class="right"> <a class="btn right" title="<?php echo t('Send an Enquiry'); ?>" href="<?php echo Yii::app()->createUrl('site/excursionenquiry',array('id' => $l->id)); ?>"> <?php echo t('Send an Enquiry'); ?> </a> 
            <a class="btn right"  title="<?php echo t('Know More'); ?>" href="<?php echo Yii::app()->createUrl('tuscanytours/detail',array('tlist'=>$meta->slug,'tdetail'=>$meta1->slug)); ?>"><?php echo t('Know More'); ?> </a></p>
            <div class="clear"></div>
          </div>
          <hr>
          <div class="clear"></div>
