  ...
  <section id="main-content">
    ...
    <div class="container marT30">
      <?php
				  ...
				  $items = 'http://'.AWS_S3_BUCKET.'.s3.amazonaws.com/'.$page->id.'/fullsize/'.$img->img_url;  
      ...
      <article class="col span_9 first tour_desc">
        ...
        <?php $i = 0; foreach ($Pgallery as $pg) { ?>
                  <?php if($i==0) { 
				   ...
				   ?>
      <li> <img src="http://<?php echo AWS_S3_BUCKET; ?>.s3.amazonaws.com/<?php echo $page->id; ?>/fullsize/<?php echo $pg->img_url; ?>" alt="<?php echo $pg->name; ?>"> </li>
      <?php  $i++; } 
