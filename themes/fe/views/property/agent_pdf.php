  ...
  <section id="main-content">
    <div class="container thin_border">
      ...
      <h4 style="text-align:center;">
       ...
       <h6 style="text-align:center;" > <a href='<?php echo FRONT_SITE_URL.$model->affiliateurl; ?>'>Click here to view this property online</h6>
       <?php 
  ...
  $Oservice = Otherservices::model()->findAll(array(
   ...
   -->
    ...
    <table>
      ...
      <tr>
        <?php for ($j = 0; $j<2; $j++) {  ?>
        <td><img style="vertical-align: top" src="<?php echo PROPERTY_IMAGES_URL.$model->id; ?>/fullsize/<?php echo $ima[$k++]; ?>" width="300" height="200" /></td>
        <?php } ?>
      </tr>
      <?php } ?>
    </table>
