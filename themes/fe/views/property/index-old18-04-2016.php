    ...
    <div class="container">
      <article class="col span_9 first property_detail">
        ...
        <p class="propinfo marB0 detail-page-info">
          ...
          <!-- <a class="right" href="#">Print this Listing</a>--> </p>
        ...
        <div class="detail-price marB0 detail-page-price">
          <div class="detail-price">
            ...
            <?php echo t('From'); ?> AU$ <?php echo prop_min_price($page->id); ?> <?php echo t('Per Week'); ?>
            <?php } ?>
          </div>
		...
		?>
          <p><?php echo str_replace($Lanchor,$Lurl, strip_tags($page->content1,'<br><p>')); ?></p>
