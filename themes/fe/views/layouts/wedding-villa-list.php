<?php
	$wedding = Pinfo::model()->findAll(array(
			'select'=>'*, rand() as rand',
			'condition'=>'status = 1 AND wedding = 1',
			'order'=>'rand',
			'limit'=>4
	)); 
	
	  if ( isset($wedding ) && (count($wedding )>0) ) {
?>
<section class="featured-listings">
  <div class="container">
    <header class="masthead">
      <h2 class="left marT0 marB0"><?php echo t('View Our Wedding Holiday and Vacation Italian Villa Collection'); ?></h2>
      <a class="view-all right" href="<?php echo Yii::app()->createUrl('ourvillas/tags',array( 'tag' => 'wedding-accommodations' )); ?>"><?php echo t('View All'); ?><i class="icon-angle-right"></i></a>
      <div class="clear"></div>
    </header>
    <ul>
      <?php 
