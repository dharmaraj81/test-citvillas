<div id="header-wrap">
  <div class="container">
    <header id="masthead">
      <div class="col span_12 inner-logo"> <a href="<?php echo FRONT_SITE_URL; ?>"> 
      <img class="logo" src="<?php echo PROPERTY_IMAGES_URL; ?>site-images/logo.png" alt="CIT Villas" /></a>
        <div class="issuu-container-inner"> 
          <!--  <a href="http://www.cit.com.au/brochure_view.aspx?id=13" title="View Brochure" target="_blank"> <div class="linktopage"><p> View Brochure  </p></div></a> --> 
          <a href="http://www.cit.com.au/brochure_view.aspx?id=13" title="View Brochure" target="_blank"> 
