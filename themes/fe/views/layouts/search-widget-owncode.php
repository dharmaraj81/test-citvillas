...
if(YII_DEBUG)
		...
		Yii::app()->clientScript->registerScriptFile($layout_asset.'/js/jquery.ddslick.min.js', CClientScript::POS_HEAD);
?>
...
<div class="threecol left webdesigntuts-workshop">
  ...
  <?php 
	...
	?>
  <div><span> Select a Region </span> <?php echo $form->dropDownList($SearchWidget, 'region', $sub_stores, array('class'=>'search_villa_widget',  'empty'=>'Select your preferred Region in Italy')); ?></div>
