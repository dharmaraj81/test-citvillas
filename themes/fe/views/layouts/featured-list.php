...
<section class="featured-listings">
  <div class="container">
    <header class="masthead">
      <h2 class="left marT0 marB0"><?php echo t('View Our Featured Holiday and Vacation Italian Villas'); ?></h2>
      <a class="view-all right" href="<?php echo Yii::app()->createUrl('ourvillas/featuredvillas'); ?>"><?php echo t('View All'); ?><i class="icon-angle-right"></i></a>
      <div class="clear"></div>
    </header>
    <ul>
      <?php 
      ...
      <li class="feat-listing col span_3 first">
        <figure>
			<div class="item wishItem">		
				...
				<img src="<?php echo Gallery::GetPropThumbnail($f->id); ?>"   alt="<?php echo $f->altTag; ?>"></a>
