...
if(YII_DEBUG)
		...
		Yii::app()->clientScript->registerCssFile($layout_asset.'/css/js-select.css');
?>
<section class="advanced-search">
<div class="container">
<h1 class="find-perfect"><?php echo t('Find The Perfect Italian Villa For Your Vacation or Holiday'); ?></h1>
<div class="threecol left webdesigntuts-workshop">
  ...
  <div class="picklist-container" ><div class="select select--white">
  <span class="placeholder">Select your preferred Region in Italy</span>
  <ul>
  <?php 
	 		   $sub_stores = array();
						...
						foreach ($RegionMenu as $Reg ) {
						    ...
						    if( isset($RegSeo) && count($RegSeo)>0 ) {
								...
								if( isset($noofprop) && count($noofprop)>0 ) { 
								   ?>
								   <a href="<?php echo $this->createUrl('ourvillas/region', array( 'region'=>$RegSeo->slug )); ?>"> <li data-value="<?php echo $Reg->id; ?>"> <?php echo $RegSeo->mainmenu; ?> </li> </a>
             <?php } } } }
	?>
...
<div class="singlecol left last map"> <img src="http://<?php echo AWS_S3_BUCKET; ?>.s3.amazonaws.com/site-images/italy-map.jpg" alt="map" border="0" usemap="#Map"/>
  <map name="Map" id="Map">
