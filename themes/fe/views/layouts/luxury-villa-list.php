<?php
	...
	$luxury = Pinfo::model()->findAll(array(

			'select'=>'*, rand() as rand',

			'condition'=>'status = 1 AND luxury = 1',
	 ...
	 if ( isset($luxury) && (count($luxury)>0) ) {
...
<section class="featured-listings">
  <div class="container">
    <header class="masthead">
      <h2 class="left marT0 marB0"><?php echo t('View Our Luxury Holiday and Vacation Italian Villa Collection'); ?> </h2>
      <a class="view-all right" href="<?php echo Yii::app()->createUrl('ourvillas/tags',array( 'tag' => 'luxury-accommodations' )); ?>"><?php echo t('View All'); ?><i class="icon-angle-right"></i></a>
      <div class="clear"></div>
    </header>
    <ul>
      <?php 
