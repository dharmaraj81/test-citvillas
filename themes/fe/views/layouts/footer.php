<footer>
    <div class="container">
      ...
      <p class="marB0 right allrights">© <?php echo date('Y',time()); ?> CIT Europe Pty Ltd, All Rights Reserved. <!-- <a id="back-to-top" href="#top">Back to top </a> --> </p>
      <div class="clear"></div>
    </div>
  </footer>
<?php //include "remarketting-code.php"; ?>
