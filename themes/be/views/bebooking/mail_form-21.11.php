...
<div class="mail_css4">
    <div class="mail_css5"><input type="text" name="names" id="names" class="names mail_css7" /></div>
    <div class="mail_css6"><input type="text" name="email" id="email" class="emails mail_css8" /></div>
    <div class="mail_css9" onclick="add_newbox()">+</div>
</div>
<input type="hidden" name="box_count" id="box_count" value="0" />
<div class="mail_css10"></div>

<div class="mail_css11">
    <div class="mail_css12">People</div>
    <div class="mail_css13"><?php echo CHtml::dropDownList('people','',CHtml::listData(People::model()->findAll(),'name','name'),array('class'=>'mail_css14'));?></div>
</div>

<div class="mail_css11">
    <div class="mail_css12">Mail Template</div>
    <div class="mail_css13"><?php echo CHtml::dropDownList('template','',CHtml::listData(Maildoc::model()->findAll(),'id','name'),array('class'=>'mail_css14'));?></div>
</div>
