...
<div class="mail_css11">
    <div class="mail_css12"></div>
    <div class="mail_css13"><?php echo CHtml::dropDownList('people','',CHtml::listData(People::model()->findAll(),'id','name'),array('empty'=>'None','class'=>'mail_css14'));?></div>
</div>
