...
$opts = array
		...
		$resp_body = file_get_contents ("http://api.int.travelmob.com/api/partner/v1/listings.xml", false, $context);
		print_r($resp_body);
...
if(file_put_contents($folderpath.'/create.xml',$xmldata)){ echo htmlspecialchars(file_get_contents($folderpath."/create.xml")); }*/
?>