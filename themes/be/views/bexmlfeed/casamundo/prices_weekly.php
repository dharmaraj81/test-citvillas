...
if (!file_exists($folderpath)) mkdir($folderpath,0777);
if(file_put_contents($folderpath.'/prices_weekly.xml',$xmldata)){ /*echo htmlspecialchars(file_get_contents($folderpath."/prices_weekly.xml"));*/ echo $folderpath.'/prices_weekly.xml file created successfully'; }
?>