...
<div id="wrapper">
  <section id="main-content">
    ...
    <br>
      ...
      <p> <strong> Address : </strong><?php echo $model->address1.', '.$model->address2; ?>,<?php echo Town::GetName($model->town).', '.Province::GetName($model->province).' , '.Region::GetName($model->region); ?>, <?php echo Countrylist::GetName(Country::GetName($model->country)).' - '.$model->zip; ?><br>
      </p>
      
      
      
      <?php if($model1->mpoint!='') { ?>
      <p> <strong> Meeting Point </strong> (if applicable to this apartment) : <?php echo $model1->mpoint; ?> </p>
      <?php } ?>
      <?php if($model1->name!='') { ?>
  ...
  $Oservice = Otherservices::model()->findAll(array(
    ...
    <!--  <iframe style="width:100%; height:350px;" src="https://maps.google.com/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=<?php echo Town::GetName($model->town).', '.Province::GetName($model->province).','; ?>+Italy&amp;aq=0&amp;oq=<?php echo Province::GetName($model->province); ?>&amp;ie=UTF8&amp;z=10&amp;output=embed"></iframe> -->
    <!-- <img src="<?php echo $layout_asset; ?>/images/map.jpg" width="100%" /> -->
