...
<div class="header"> <a class="logo" href="<?php echo bu().'/besite'; ?>"><img src="<?php echo $backend_asset; ?>/images/logo-inverse.png" alt="BookEasy - Ciao Italy Pty Ltd" title="BookEasy - Ciao Italy Pty Ltd" /></a>
  <div class="ciao-address">
    <p>CIT Europe Pty Ltd <br/>
      ...
      Sydney NSW 2000 <br/>
      Australia +61 292671255 ext 2133 <br/>
...
<div class="menu">
  ...
  <div class="admin">
    ...
    <ul class="control">
      ...
      <?php } ?>
      <li><span class="icon-comment"></span> <a target="_blank" href="<?php echo FRONT_SITE_URL; ?>"><?php echo t('View Site'); ?></a></li>
...
*/					    ),'visible'=>( (user()->isOperator) || (user()->isAdmin) ) ? true : false),
						...
						array('label'=>'<span class="icon-leaf"></span><span class="text">'.t('Calendar Type').'</span>', 'url'=>array('/becaltype/admin'),'visible'=>((user()->isAdmin) ) ? true : false,),
						array('label'=>'<span class="icon-leaf"></span><span class="text">'.t('Property Calendar').'</span>', 'url'=>array('/bepropcal/admin'),'visible'=>( (user()->isOperator) || (user()->isAdmin) ) ? true : false,),
					    ...
					    'items'=>array(
						array('label'=>'<span class="icon-tasks"></span><span class="text">'.t('Booking Calculation Method').'</span>', 'url'=>array('/becalculationmethod/admin')),
						array('label'=>'<span class="icon-search"></span><span class="text">'.t('Availability').'</span>', 'url'=>array('/bebooking/availability')),
						array('label'=>'<span class="icon-gift"></span><span class="text">'.t('Bookings').'</span>', 'url'=>array('/bebooking/reserve'), )
					    ),'visible'=>( (user()->isOperator) || (user()->isAdmin) ) ? true : false,),
                        ...
                        array('label'=>'<span class="isw-empty_document"></span><span class="text">'.t('Reports'), 'url'=>'#', 'itemOptions'=>array('class'=>'openable'), 
						   'items'=>array(
							   ...
							   array('label'=>'<span class="icon-calendar"></span><span class="text">'.t('Agent Commission').'</span>', 'url'=>array('/bereports/agentcommission')),
						),
							'visible'=>user()->isAdmin ? true : false,   
						),
						
					array('label'=>'<span class="isw-user"></span><span class="text">'.t('Travel Agent').'</span>', 'url'=>'#', 'itemOptions'=>array('class'=>'openable'), 
					       'items'=>array(
						
						array('label'=>'<span class="icon-user"></span><span class="text">'.t('Manage Travel Agents').'</span>', 'url'=>array('/betravelagent/admin')),
					...
					array('label'=>'<span class="isw-user"></span><span class="text">'.t('User').'</span>', 'url'=>'#', 'itemOptions'=>array('class'=>'openable'), 
						...
						array('label'=>'<span class="icon-ok-sign"></span><span class="text">'.t('Permission').'</span>', 'url'=>array('/rights/assignment'),'active'=>in_array(Yii::app()->controller->id,array('assignment','authItem')) ?true:false),
						 ...
						 array('label'=>'<span class="isw-settings"></span><span class="text">'.t('Master Data'), 'url'=>'#', 'itemOptions'=>array('class'=>'openable'), 
                                           'items'=>array(
                                               array('label'=>'<span class="icon-wrench"></span><span class="text">'.t('Currency').'</span>', 'url'=>array('/currencymanager/currency/admin')),
                                               array('label'=>'<span class="icon-tasks"></span><span class="text">'.t('Commission').'</span>', 'url'=>array('/becommission/admin')),
                                        ),
                                            'visible'=>user()->isAdmin ? true : false,   
                                        ),
