...
*/					    ),'visible'=>( (user()->isOperator) || (user()->isAdmin) ) ? true : false),
						...
						array('label'=>'<span class="icon-leaf"></span><span class="text">'.t('Currency Rates').'</span>', 'url'=>array('/currencymanager/currency/admin'),'visible'=>( (user()->isOperator) || (user()->isAdmin) ) ? true : false,),
